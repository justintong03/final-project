...
var die1, die2, dieSum, balance, banner, outcome, die1Name, die2Name, numRolls, plays; // define variables
...
function letsPlay(){
  plays = prompt("How many times do you want to play?");
  ...
  loop()
  alert("Your balance is " + balance + " dollars. Thank you for playing.")
}
